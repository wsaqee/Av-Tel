...
class apds9960 : public i2cComm
{
    public:
        ...
        bool enableGestureSensor(bool interrupts = false);
...
//uint8 - int
        ...
        int getGestureEnterThresh();
        bool setGestureEnterThresh(int threshold);
        int getGestureExitThresh();
        bool setGestureExitThresh(int threshold);

        /* Gesture LED, gain, and time control */
        int getGestureWaitTime();
        bool setGestureWaitTime(int time);

        /* Gesture mode */
        int getGestureMode();
        bool setGestureMode(int mode);
